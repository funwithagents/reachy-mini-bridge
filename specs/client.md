...
3. **Error taxonomy.** The exception types the seam/api raises for connection and state errors (e.g. motors-disabled) — settled with [api.md](api.md)'s movement-verb error-type question, once the Api and Tools' failure-reporting shape is chosen.
